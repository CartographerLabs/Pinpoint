...
with open(r'outputs/training_features.json') as json_file:
...
print("Of the '{}' posts with a centrality higher than 0, '{}%' were extreamist posts and '{}%' were non-extreamist posts".format(
    total,is_extreamist_percentage, not_extreamist_percentage
))

with open("centrality-count.txt", 'w', encoding="utf8") as outfile:
    json.dump(comparison_dict, outfile)