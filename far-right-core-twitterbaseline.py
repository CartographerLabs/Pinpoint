...
extractor = feature_extraction(violent_words_dataset_location=r"C:\Projects\Pinpoint\datasets\swears",
                               baseline_training_dataset_location=r"C:\Projects\Pinpoint\datasets\far-right\LIWC2015 Results (Storm_Front_Posts).csv")

extractor.dump_training_data_features(
    feature_file_path_to_save_to=r"C:\Projects\Pinpoint\outputs\training_features.json",
    extremist_data_location=r"C:\Projects\Pinpoint\datasets\far-right\LIWC2015 Results (extreamist-messages.csv).csv",
...
model.train_model(features_file= r"C:\Projects\Pinpoint\outputs\training_features-tweeter-baseline.json",
...
model.create_model_info_output_file(location_of_output_file="outputs/far-right-baseline-output-twitter-baseline.txt",
                                    training_data_csv_location=r"C:\Projects\Pinpoint\outputs\training_features-tweeter-baseline.json.csv")
