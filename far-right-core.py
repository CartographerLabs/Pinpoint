...
extractor.dump_training_data_features(
    ...
    baseline_data_location=r"\Pinpoint\datasets\far-right\LIWC2015 Results (non-extreamist-messages.csv).csv",
...
model.train_model(features_file= r"\Pinpoint\outputs\training_features.json",
...
model.create_model_info_output_file(location_of_output_file="outputs/far-right-baseline-output.txt",
                                    training_data_csv_location=r"\Pinpoint\outputs\training_features.json.csv")
